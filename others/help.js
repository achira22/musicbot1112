...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Help")
      .setAuthor('Click here to invite me!!', 'https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png', 'https://discord.com/oauth2/authorize?client_id=861973149661528075&scope=bot&permissions=0')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png")
      .setColor("#ff00cc");
