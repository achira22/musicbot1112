...
execute(message) {
    ...
    .setAuthor(`Loop is now ${queue.loop ? " enabled" : " disabled"}`, "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png")
