...
async execute(message,args,client) {
  ...
  .setColor("#F0EAD6")
  .setAuthor(`${message.author.username} stopped the music!`, "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png"))
  .catch(console.error);
  }
};
