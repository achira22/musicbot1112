...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor("Applying: " + args[0], "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png","https://discord.com/oauth2/authorize?client_id=861973149661528075&scope=bot&permissions=0")).then(msg =>{
