...
module.exports = {
  async play(song, message, client, filters) { 
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png")
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png";
    else thumb = song.thumbnail.url;

  try {
      let embed = new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor(`Started playing: ${song.title}`,'https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png')
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        if (!queue)
          ...
          .setAuthor("Searching...", "https://cdn.discordapp.com/attachments/791353889093713931/865232648799256606/189-1898531_music-logo-m-logo-png-transparent-png.png").setFooter("Lyrics")
          .setColor("#F0EAD6")
